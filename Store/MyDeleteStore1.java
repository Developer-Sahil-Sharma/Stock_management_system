...
import javax.swing.*;
public class MyDeleteStore1 extends JFrame implements ActionListener {
	JComboBox t1;
	JLabel k;
JTextField t2,t3,t4,t5,t6,t7,tt;
JButton btn,btn1,btn2;
private JPanel contentPane;  
public  MyDeleteStore1() {
	  setSize(1370,800);
	   ...
	   setContentPane(contentPane);  
		...
		add(t7);
		 t7.setFont(new Font("Book Antiqua",Font.BOLD,15));
		    ...
		    tt=new JTextField("    Delete STORE");
...
try
{
	Class.forName("oracle.jdbc.OracleDriver");
c= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","manager");
String sql="delete from store1 where strid=?";
st=c.prepareStatement(sql);
st.setString(1, f);
