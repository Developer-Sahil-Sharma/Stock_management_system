...
import javax.swing.*;
public class MyInsStore1 extends JFrame implements ActionListener,FocusListener {
	JLabel k,msg1;
	int x=0;
...
if (a1.length()==0 || b1.length()==0 || c1.length()==0 || d1.length()==0 || e1.length()==0||f1.length()==0||g1.length()==0)
{
...
try
{
 ...
 String sql="insert into store1 values(?,?,?,?,?,?,?)";
...
public void focusLost(FocusEvent e) {
	if (e.getSource()==t1)
	{
		...
		if (a1.length()==0)
		{
			msg1.setText("Please Enter your Store ID ");
