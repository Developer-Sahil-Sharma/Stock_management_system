...
public class MyFindSpplier3 extends JFrame implements ActionListener {
		...
		setSize(1370,800);
		   ...
		   setContentPane(contentPane);  
			...
			t6.setBackground(Color.white);
			    ...
			    tt=new JTextField("      FIND SUPPLIER");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==btn1)
		{
			...
			try
			{
				...
				String sql="select splname,spladd,splcity,splemail,itmid from supplier3 where splid=? ";
