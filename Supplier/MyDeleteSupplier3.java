...
import javax.swing.*;
public class MyDeleteSupplier3 extends JFrame implements ActionListener {
	JLabel k;
	JComboBox t1;
	JTextField tt,t2,t3,t4,t5,t6;
	JButton btn,btn1,btn2;
	 private JPanel contentPane;
	public MyDeleteSupplier3()
	{
		setSize(1370,800);
	   ...
	   setContentPane(contentPane);  
		...
		t6.setBackground(Color.white);
		    ...
		    tt=new JTextField("      DELETE SUPPLIER");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btn2)
		{
			...
			try
			{
				Class.forName("oracle.jdbc.OracleDriver");	
				c=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","manager");
				String sql="delete from supplier3 where splid=?";
				st=c.prepareStatement(sql);
				st.setString(1, f);
