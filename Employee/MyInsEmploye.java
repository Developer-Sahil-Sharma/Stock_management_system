...
public class MyInsEmploye extends JFrame implements ActionListener ,FocusListener{

	
	JTextField t1,t2,t3,t4,t5,t6,tt;
	...
	public MyInsEmploye()
	{
	   ...
	   setContentPane(contentPane);  
		...
		tt=new JTextField("      INSERT EMPLOYEE");
	...
	public void focusLost(FocusEvent e) {
		if (e.getSource()==t1)
		{
			...
			if (a1.length()==0)
			{
				msg1.setText("Please Enter your Employe ID ");
