...
import javax.swing.*;
public class MyUpdateEmploye extends JFrame implements ActionListener {
	JComboBox t1;
	JTextField tt,t2,t3,t4,t5,t6;
	JButton btn,btn1,btn2;
	JLabel k;
	private JPanel contentPane;
	public MyUpdateEmploye()
	{setSize(1370,800);
   ...
   setContentPane(contentPane);  
	...
	tt=new JTextField("      Update Employee");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==btn2)
		{
		    ...
		    try
		    {
		    	Class.forName("oracle.jdbc.OracleDriver");
		    	c= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","manager");
		    	String sql="update employe set name=?,age=?,branch=?,salary=?,address=? where empid=?";
		    	st=c.prepareStatement(sql);
		    	st.setString(1, b1);
				st.setString(2, c1);
				st.setString(3, d1); 
