...
public class MyUpdateCustomer6 extends JFrame implements ActionListener {
...
MyUpdateCustomer6()
	{
	 setSize(1370,800);
	   ...
	   setContentPane(contentPane);  
		...
		tt=new JTextField("       Update CUSTOMER");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btn2)
		{
			...
			try
			{
				Class.forName("oracle.jdbc.OracleDriver");
		    	c= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","manager");
		    	String sql="update customer6 set custname=?,custemail=?,custadd=?,custcity=?,custph=? where custid=?";
		    	st=c.prepareStatement(sql);
		    	st.setString(1, b1);
				st.setString(2, c1);
				st.setString(3, d1);
