...
import javax.swing.*;
public class MyInsCustomer6 extends JFrame implements ActionListener,FocusListener {
JLabel k,msg1;
int x=0;
JTextField t1,t2,t3,t4,t5,t6,t7,tt;
JButton btn,btn1;
private JPanel contentPane; 
  public MyInsCustomer6 () {
		 setSize(1370,800);
		   ...
		   setContentPane(contentPane);  
			...
			tt=new JTextField("       INSERT CUSTOMER");
...
try
{
 ...
 String sql="insert into customer6 values(?,?,?,?,?,?)";
...
public void focusLost(FocusEvent e) {
	if (e.getSource()==t1)
	{
		...
		if (a1.length()==0)
		{
			msg1.setText("Please Enter your Customer id");
