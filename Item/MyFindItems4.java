...
import javax.swing.*;
public class MyFindItems4 extends JFrame implements ActionListener {
	JLabel k;
	JComboBox t1;
	JTextField t2,t3,t4,t5,t6,t7,t8,tt;
	JButton btn,btn1;
...
public MyFindItems4() {
   ...
   setContentPane(contentPane);  
	...
	btn.setBounds(600,580,100,30);
	add(btn);
	btn.addActionListener(this);
    btn.setFont(new Font("Georgia",Font.BOLD,15));
    btn.setBackground(Color.RED);
	tt=new JTextField("       Find ITEMS");
...
//	int currq=Integer.parseInt(t7.getText());
