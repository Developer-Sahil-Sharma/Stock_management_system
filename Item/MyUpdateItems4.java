...
public class MyUpdateItems4 extends JFrame implements ActionListener {
     ...
     MyUpdateItems4()
	{
    	 setSize(1370,800);
    	   ...
    	   setContentPane(contentPane);  
    		...
    		tt=new JTextField("       UPDATE ITEMS");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btn2)
		{
			...
			try
			{
				Class.forName("oracle.jdbc.OracleDriver");
		    	c= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","manager");
		    	String sql="update Items4 set procatid=?,itmname=?,unit=?,price=?,openquant=?,disquantity=? where itmid=?";
		    	st=c.prepareStatement(sql);
		    	st.setString(1, b1);
				st.setString(2, c1);
				st.setString(3, d1);              
