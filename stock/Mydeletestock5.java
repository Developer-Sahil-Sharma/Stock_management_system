...
import javax.swing.*;
public class Mydeletestock5 extends JFrame implements ActionListener {
JComboBox t1;
	JTextField tt,t2,t3,t4,t5,t6;
	JButton btn,btn1,btn2;
	JLabel k;
	private JPanel contentPane; 
	public Mydeletestock5()
	{
     setSize(1370,800);
	   ...
	   setContentPane(contentPane);  
		...
		tt=new JTextField("       Delete Stock");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btn2)
		{
			...
			try
			{
				Class.forName("oracle.jdbc.OracleDriver");	
				c=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","manager");
				String sql="delete from stock5 where stockid=?";
				st=c.prepareStatement(sql);
				st.setString(1, f);
