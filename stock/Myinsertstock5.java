...
public class Myinsertstock5 extends JFrame implements ActionListener ,FocusListener{
...
setSize(1370,800);
	   ...
	   setContentPane(contentPane);  
		...
		tt=new JTextField("       Insert Stock");
	...
	public void actionPerformed(ActionEvent e) {
		...
		try
		{
			...
			String sql="insert into stock5 values(?,?,?,?,?,?)";
