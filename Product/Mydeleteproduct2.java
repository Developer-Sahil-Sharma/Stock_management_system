...
import javax.swing.*;
public class Mydeleteproduct2 extends JFrame implements ActionListener {
JComboBox t1;
	JTextField tt,t2,t3;
	JButton btn,btn1,btn2;
	JLabel k;
	 private JPanel contentPane;
	public Mydeleteproduct2()
	{
		 setSize(1370,800);
			...
			tt=new JTextField("      DELETE PRODUCT ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btn2)
		{
			...
			try
			{
				Class.forName("oracle.jdbc.OracleDriver");	
				c=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","manager");
				String sql="delete from product2 where proid=?";
				st=c.prepareStatement(sql);
				st.setString(1, f);
