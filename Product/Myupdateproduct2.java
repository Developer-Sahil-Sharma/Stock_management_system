...
import javax.swing.*;
public class Myupdateproduct2 extends JFrame implements ActionListener {
	JComboBox t1;
	JTextField t2,t3,tt;
	JLabel k;
	 private JPanel contentPane;
	JButton btn,btn1,btn2;
	public Myupdateproduct2() {
		 ...
		 setSize(1370,800);
			...
			tt=new JTextField("      Update PRODUCT ");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==btn2)
		{
		    ...
		    try
		    {
		    	Class.forName("oracle.jdbc.OracleDriver");
		    	c= DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","manager");
		    	String sql="update product2 set proname=?,prodis=? where proid=?";
		    	st=c.prepareStatement(sql);
		    	st.setString(1, b1);
		    	st.setString(2, c1);
				st.setString(3, f); 
